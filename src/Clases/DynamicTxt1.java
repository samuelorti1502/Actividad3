...
public class DynamicTxt1 extends Thread {
    ...
    public DynamicTxt1(String cadena, int sleep, JLabel lblCadena, JLabel lblMensaje) throws Exception {
        try {
            this.cadena = cadena;
            this.sleep = sleep;
            ...
            if (this.cadena.length() == 0) {
                MSG_ERROR = "Ingrese una cadena no vacía. ";
            }
            if (this.sleep < 0) {
                MSG_ERROR = "Ingrese un valor para sleep mayor o igual que cero (0). ";
            }
            if (!MSG_ERROR.equals("")) {
